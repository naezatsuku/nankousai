...
export default function Gallery () {
    ...
    const img_tags = [
        {title:"第71回南高祭ポスター", img:"/第71回 南高祭ポスター（376x524mm）.webp"},
        {title:"第72回南高祭ポスター", img:"/第72回 南高祭ポスター（376x524mm）.webp"},
    ...
    return(
        <div className="w-full bg-white">   
            <h2 className={`mb-[5vw] ${kaiseiDecol.className} text-center text-[12vw] 2xl:text-8xl lg:text-6xl lg:mb-16  `}>ギャラリー</h2>
