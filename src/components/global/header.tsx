            ...
            <div className="w-full h-full flex items-center justify-between">
                <Link href={"/"} onClick={clickLogo}>
                    <motion.div whileHover={{scale:1.05, opacity:1}} whileTap={{scale:0.9}} transition={{type:"spring", duration:0.2, bounce:0.2}} className="relative ml-[3.5vw] flex items-center opacity-90 xl:ml-10 ">
                        <Image src={"/70周年ロゴB.png"} alt="70周年ロゴ" width={200} height={200} className="h-[6.8vw] w-[7vw] lg:w-9 lg:h-9 xl:h-10 xl:w-10 xl:translate-y-[0.1rem]"></Image>
                ...
                <div ref={targetMenu} className={`overflow-hidden w-full h-0  bg-gradient-to-br opacity-[0.92]    base-gradient absolute top-0 left-0 z-0 `}>    
